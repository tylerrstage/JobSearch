...
const Searchbar = forwardRef(function Searchbar(props, ref) {
  ...
  return (
    <div className='flex flex-wrap gap-4 my-10 justify-center px-10'>
        ...
        <button onClick={search} className='shadow-float-dark bg-ink-900 text-white font-bold py-2 px-6 rounded-full 
        hover:bg-ink-800 active:bg-black cursor-pointer transition-colors'>Search</button>
    </div>
  )
})
